DO $$ BEGIN
 CREATE TYPE "public"."status_change_kind" AS ENUM('activate', 'deactivate');
EXCEPTION
...
CREATE TABLE IF NOT EXISTS "status_changes" (
	...
	"kind" "status_change_kind" NOT NULL
);
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "status_changes" ADD CONSTRAINT "status_changes_product_products_id_fk" FOREIGN KEY ("product") REFERENCES "public"."products"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
